 ...
 * */
public class CellsFieldRec {
	public Cell[][] field;
	private int width;
	private int height;
	
	public CellsFieldRec(int w, int h){
		this.width = w;
		this.height = h;
	...
	private void update(int x, int y){
		...
		boolean nextValue = this.field[x][y].nextValue();
		this.update(x+1, y);
		this.field[x][y].setLive(nextValue);
	}
	...
	private class UpperLeftCell extends Cell{
		...
		public boolean nextValue() {
			int n = 0;
			if (CellsFieldRec.this.field[super.posX+1][super.posY].isAlive()) n++;
			if (CellsFieldRec.this.field[super.posX][super.posY+1].isAlive()) n++;
			if (CellsFieldRec.this.field[super.posX+1][super.posY+1].isAlive()) n++;
